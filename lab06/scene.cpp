...
{  
	...
	Moon = new glSphere(7, "textures\\moon.bmp");
...
{	
	...
	/*glm::mat4 mModelView = glm::lookAt(glm::vec3(5.0,0.0,5.0),glm::vec3(0.0f),glm::vec3(0.0f, 1.0f, 0.0f));*/
	glm::mat4 mModelView = glm::lookAt(glm::vec3(Cam_r*cos(PI*Cam_angle / 180.0f), 0.0f,Cam_r*sin(PI*Cam_angle / 180.0f)),glm::vec3(0.0f),glm::vec3(0.0f, 1.0f, 0.0f));
