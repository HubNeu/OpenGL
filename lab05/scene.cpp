...
{  
	...
	Cube = new glObject();
	Face1 = new glTexture("textures\\happy.bmp");

	Cube->SetColor(0.9f,0.9f,0.9f);	

	// sciany prostopadle do OX
	Cube->SetNormal(1.0,0.0,0.0);
	Cube->BeginObject(GL_TRIANGLE_STRIP,Face1->Bind());	
	...
	Face2 = new glTexture("textures\\sad.bmp");
	...
	Face3 = new glTexture("textures\\crying.bmp");

	Cube->SetNormal(0.0,0.0,1.0);
	Cube->BeginObject(GL_TRIANGLE_STRIP, Face3->Bind());
	Cube->AddVertex(-0.5,0.5,0.5, 0.0, 1.0);
	Cube->AddVertex(-0.5,-0.5,0.5, 0.0, 0.0);
	Cube->AddVertex(0.5,0.5,0.5, 1.0, 1.0);
	Cube->AddVertex(0.5,-0.5,0.5, 1.0, 0.0);
	...
	Face4 = new glTexture("textures\\angry.bmp");

	Cube->SetNormal(0.0,0.0,-1.0);
	Cube->BeginObject(GL_TRIANGLE_STRIP, Face4->Bind());
	Cube->AddVertex(-0.5,0.5,-0.5, 0.0, 1.0);
	Cube->AddVertex(-0.5,-0.5,-0.5, 0.0, 0.0);
	Cube->AddVertex(0.5,0.5,-0.5, 1.0, 1.0);
	Cube->AddVertex(0.5,-0.5,-0.5, 1.0, 0.0);
