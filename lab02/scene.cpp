...
{  
	...
	pos_tab[0] = -0.5; pos_tab[1] = -0.5; pos_tab[2] = 0;//x,y,z,pkt 1,2,3,4
	pos_tab[3] = -0.5; pos_tab[4] = 0.5; pos_tab[5] = 0;
	pos_tab[6] = 0.5; pos_tab[7] = -0.5; pos_tab[8] = 0;
	pos_tab[9] = 0.5; pos_tab[10] = 0.5; pos_tab[11] = 0;
...
{            
	...
	sprintf(_msg, "%d", key);
	PrintLog(_msg);
	if (key == VK_DOWN) dY -= 0.05;
	if (key == VK_UP) dY += 0.05;
	if (key == VK_LEFT) dX -= 0.05;
	if (key == VK_RIGHT) dX += 0.05;
	if (key == 'S' || key == 's') dY2 -= 0.05;
	if (key == 'W' || key == 'w') dY2 += 0.05;
	if (key == 'A' || key == 'a') dX2 -= 0.05;
	if (key == 'D' || key == 'd') dX2 += 0.05;
